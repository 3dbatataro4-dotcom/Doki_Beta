window.day3_script = {
    ...
    day3_morning_encounter: [
        ...
        { char: "peter", name: "彼得", emotion: "confused", text: "（拿著一張通知單，瞳孔緊縮）Shit...這是防火牆的警告信號？還是生命體徵報警？", effect: "shake" },
        { char: "lanlan", name: "蘭蘭", emotion: "smile", text: "彼得你又在說胡話啦？那是風紀委員會的社團整頓通知呀！", effect: "jump" },
        { char: "ora", name: "奧拉", emotion: "normal", text: "......系統開始自動清理無效進程了？不，這只是普通的校園劇情結算點。", effect: "breathe" },
        { text: "原來是因為我們社團的活動紀錄太過空白，被學校要求整改了。", name: "我" }
    ],
