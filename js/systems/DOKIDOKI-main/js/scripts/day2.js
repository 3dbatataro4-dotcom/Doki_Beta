window.day2_script = {
    ...
    day2_morning_encounter: [
        ...
        { char: "peter", name: "彼得", emotion: "normal", text: "（拿著放大鏡檢查桌面）0.01毫米的灰塵...不可原諒。", effect: "shake" },
        { char: "lanlan", name: "蘭蘭", emotion: "bored", text: "（趴在桌上，玩著一顆乾癟的櫻桃）好無聊呀...燒起來會是什麼顏色呢？", effect: "breathe" },
        { char: "ora", name: "奧拉", emotion: "normal", text: "（看著旁邊空蕩蕩的椅子）......質量守恆定律在這裡似乎失效了。", effect: "breathe" },
        { text: "他們看起來都心事重重。", name: "我" }
    ],
    ...
    day2_break_peter: [
        ...
        { char: "peter", name: "彼得", emotion: "confused", text: "以前...這裡總是有個髒兮兮的影子跟著我。雖然很髒，但很安心。", effect: "shake" },
        { char: "peter", name: "彼得", emotion: "normal", text: "現在太乾淨了。乾淨得讓人噁心。你懂嗎？庶民。" },
